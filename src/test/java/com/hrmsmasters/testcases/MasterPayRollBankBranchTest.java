...
public class MasterPayRollBankBranchTest extends TestBase{
	LoginPage loginPage;
...
SoftAssert softAssert = new SoftAssert();
	...
	public MasterPayRollBankBranchTest() {
		super();
	}
...
//	}
	...
	@Test(priority=2)
	public void verifyAddPayrollBankBranch() throws InterruptedException {
		Assert.assertTrue(maspayrollbankbranch.addPayrollBankBranch(prop.getProperty("BANKNAME"),prop.getProperty("BRANCHNEAME"),prop.getProperty("BRANCHCODE")));
		
	}
	
	@Test(priority=3)
	public void verifyPayrollBankBranchNegativeCheck() throws InterruptedException {
	
	String valuecheck=maspayrollbankbranch.PayrollBankBranchNameNegativeCheck(prop.getProperty("BANKNAME"),prop.getProperty("BRANCHNAMENegative"),prop.getProperty("BRANCHCODE"));
	System.out.println(valuecheck);
	Assert.assertEquals("Enter Branch Name", valuecheck);				
	}
	
	@Test(priority=4)
	public void verifyPayrollBankBranchBanknameMandatoryFieldCheck() throws InterruptedException {
	
	String valuecheck=maspayrollbankbranch.PayrollBankBranchBankNameMandatoryFieldCheck(prop.getProperty("BRANCHNEAME"),prop.getProperty("BRANCHCODE"));
	System.out.println(valuecheck);
	Assert.assertEquals("Select Bank Name", valuecheck);				
	}
	
	@Test(priority=5)
	public void verifyPayrollBankBranchBranceNameMandatoryFieldCheck() throws InterruptedException {
	
	String valuecheck=maspayrollbankbranch.PayrollBankBranchNameMandatoryFieldCheck(prop.getProperty("BANKNAME"),prop.getProperty("BRANCHCODE"));
	System.out.println(valuecheck);
	Assert.assertEquals("Enter Branch Name", valuecheck);				
	}
	
	@Test(priority=6)
	public void verifyPayrollBankBranchBranceCodeMandatoryFieldCheck() throws InterruptedException {
	
	String valuecheck=maspayrollbankbranch.PayrollBankBranchBrachCodeMandatoryFieldCheck(prop.getProperty("BANKNAME"),prop.getProperty("BRANCHNEAME"));
	System.out.println(valuecheck);
	Assert.assertEquals("Enter IFSC Code", valuecheck);				
	}
	
	
//	@Test(priority=7)
//	public void verifyPayrollBankBranchDuplicateCheck() throws InterruptedException {
//	
//	String valuecheck=maspayrollbankbranch.PayrollBankBranchDuplicateCheck(prop.getProperty("DuplicateBANKNAME"),prop.getProperty("DuplicateBRANCHNEAME"),prop.getProperty("DuplicateBRANCHCODE"));
//	System.out.println(valuecheck);
...
//	}
	...
	@Test(priority=8)
	public void verifyPayrollBankBranchResetBtn() throws InterruptedException {
		
		Assert.assertTrue(maspayrollbankbranch.ResetBtnPayrollBankBranch(prop.getProperty("BANKNAME"),prop.getProperty("BRANCHNEAME"),prop.getProperty("BRANCHCODE")));
			
	}
	
//	@Test(priority=9)
//	public void verifyPayrollBankBranchPagination() throws InterruptedException {
//		
//		maspayrollbankbranch.isnextbuttonPaginationVisible();
//		
//			
//	}
	
	@Test(priority=10)
	public void VerifyEnterTheSearchPayrollBankBranchPagination() throws InterruptedException {
		Assert.assertTrue(maspayrollbankbranch.searchPayrollBankBranchpagination(prop.getProperty("SearchBranchname")));
	}
