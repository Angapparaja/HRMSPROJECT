...
public class MasterReimbursementEmployeeListViewTest extends TestBase{
	...
	public MasterReimbursementEmployeeListViewTest() {
		super();
	}
...
//	}
	...
	@Test(priority=2)
	public void verifyReimbursementEmployeeListView() throws InterruptedException {
		
	EmployeeListView.ReimbursementEmployeeListViewvalue(prop.getProperty("EMPCODElIST"),prop.getProperty("cOMPONENTempList"));	
					
	}
	
	@Test(priority=3)
	public void verifyReimbursementEmployeeListViewListCommandCheck() throws InterruptedException {
		
		String valuecheck=EmployeeListView.ReimbursementEmployeeListViewRunCommand(prop.getProperty("EMPCODElIST"),prop.getProperty("cOMPONENTempList"));
		System.out.println(valuecheck);
//		Assert.assertEquals("please choose component", valuecheck);	
	}
	
	@Test(priority=4)
	public void verifyReimbursementEmployeeListViewComponentMandatroyField() throws InterruptedException {
		
		String valuecheck=EmployeeListView.ReimbursementEmployeeListViewComponentMandatoryFieldCheck(prop.getProperty("EMPCODElIST"));
		System.out.println(valuecheck);
//		Assert.assertEquals("please choose component", valuecheck);	
	}
	
//	@Test(priority=5)
//	public void verifyMasterReimbursementEmployeeListViewPagination() throws InterruptedException {
//		
//		EmployeeListView.isnextbuttonReimbursementEmployeeListViewVisible();
//	
//	}
	
//	@Test(priority=4)
//	public void VerifyEnterTheSearchReimbursementBillsPagination() throws InterruptedException {
//		Assert.assertTrue(Bills.searchPayrollHolidayWorkComponentpagination(prop.getProperty("SearchNameholiday"),prop.getProperty("SearchNamecheckCondition")));
//	}
//	
//	@Test(priority=5)
//	public void verifyMasterReimbursementBillsEditValue() throws InterruptedException {
//		
//		String valuecheck=Bills.searchPayrollHolidayWorkComponentEdit(prop.getProperty("SearchNameholidays"));
//	//	System.out.println(valuecheck);
