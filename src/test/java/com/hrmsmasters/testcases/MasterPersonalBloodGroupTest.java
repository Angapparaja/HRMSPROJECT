...
public class MasterPersonalBloodGroupTest extends TestBase{
	...
	public MasterPersonalBloodGroupTest() {
		super();
	}
...
//	}
	...
	public void verifyaddBloodGroup() throws InterruptedException {
		
	Assert.assertTrue(addBloodGroup.addbloodGroupName(prop.getProperty("Bloodgroup")));
					
	}
	
	@Test(priority=2, enabled = true)
	public void verifyBloodGroupNegativeCheck() throws InterruptedException {
		
	String Bloodname=addBloodGroup.bloodGroupNameNegativeCheck(prop.getProperty("BloodgroupNegativeCheck"));
	System.out.println(Bloodname);
	Assert.assertEquals("Please Enter valid Blood Group", Bloodname);
					
	}
	
	@Test(priority=3, enabled = true)
	public void verifyaddBloodGroupMandatroyField() throws InterruptedException {
		
		
		String Bloodname=addBloodGroup.addbloodGroupNameMandatoryFieldVaidation();
		System.out.println(Bloodname);
		Assert.assertEquals("Enter bloodgroup Name", Bloodname);	
	}
	
		
	@Test(priority=4, enabled = true)
	public void verifyaddBloodGroupDuplicateCheck() throws InterruptedException {
		String Bloodname=addBloodGroup.addbloodgroupADDDuplicateCheckValidation(prop.getProperty("BloodgroupDuplicate"));
		System.out.println(Bloodname);
//		if(driver.getTitle().equalsIgnoreCase("Perks Admin")) {
//			Assert.assertEquals("Duplicate Data Please Check", Bloodname);
//			}
//			else {
//				Assert.assertEquals("Duplicate Data - please check", Bloodname);
//			}		
	...
	public void verifyreset() throws InterruptedException {
		...
		Assert.assertTrue(addBloodGroup.addbloodgroupNameResetButton(prop.getProperty("Bloodgroup"))); 
	...
	public void verifyPagination() throws InterruptedException {
		...
		addBloodGroup.isnextbuttonPaginationVisible();
		
			
	}

	@Test(priority=7, enabled = true)
	public void verifySearchBloodGroupNamePagination() throws InterruptedException {
		
	Assert.assertTrue(addBloodGroup.searchBloodGroupNamepagination(prop.getProperty("BloodgroupDuplicate")));	
