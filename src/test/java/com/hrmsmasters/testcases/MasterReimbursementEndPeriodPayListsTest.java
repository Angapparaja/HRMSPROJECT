...
public class MasterReimbursementEndPeriodPayListsTest extends TestBase{
	...
	public MasterReimbursementEndPeriodPayListsTest() {
		super();
	}
...
//	
	@Test(priority=2)
	public void verifyReimbursementEndPeriodPayLists() throws InterruptedException {
		
	Assert.assertTrue(EndPeriodPayLists.ReimbursementEndPeriodPayLists());	
					
	}
	
	@Test(priority=3)
	public void verifyReimbursementEndPeriodPayListsCheck() throws InterruptedException {
		
		String valuecheck=EndPeriodPayLists.ReimbursementEndPeriodPayListsValue();
		System.out.println(valuecheck);
		Assert.assertEquals("REIMBURSEMENT END PERIOD PAY LISTS", valuecheck);	
	}
...
//	}
	...
	@Test(priority=4)
	public void verifyMasterReimbursementEndPeriodPayListsPagination() throws InterruptedException {
		
		EndPeriodPayLists.isnextbuttonReimbursementEndPeriodPayListsViewVisible();
