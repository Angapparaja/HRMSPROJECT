...
public class MasterStatutorySuperAnnuationTest extends TestBase{
	...
	public MasterStatutorySuperAnnuationTest() {
		super();
	}
...
//	}
	...
	@Test(priority=2)
	public void verifyStatutorySuperAnnuationUpdateCheck() throws InterruptedException {
		
	Assert.assertTrue(StatutorySuperAnu.MasterStatutoryMenuSUPERANNUATIONAdd(prop.getProperty("SUPERCOMPONENT"),prop.getProperty("SUPERMONTH")));
	}
	
	@Test(priority=3)
	public void verifyStatutoryMenuSuperAnnuationResetButtonCheck() throws InterruptedException {
		
		Assert.assertTrue(StatutorySuperAnu.MasterStatutoryMenuSUPERANNUATIONResetButton(prop.getProperty("SUPERCOMPONENT"),prop.getProperty("SUPERMONTH")));

	}
	
//	@Test(priority=4)
//	public void verifyStatutoryMenuSuperAnnuationMonthMandatoryFieldCheck() throws InterruptedException {
//		
//	String valuecheck=StatutorySuperAnu.MasterStatutorySUPERANNUATIONMonthMandatoryFieldCheck(prop.getProperty("SUPERCOMPONENT"),prop.getProperty("SUPERMONTHMandatoryCheck"));
//         
...
//	@Test(priority=5)
//	public void verifyMasterStatutoryMenuSuperAnnuationPagination() throws InterruptedException {
//		
//		StatutorySuperAnu.isnextbuttonStatutorySUPERANNUATIONPaginationVisible();
//	
//	}
	@AfterMethod
