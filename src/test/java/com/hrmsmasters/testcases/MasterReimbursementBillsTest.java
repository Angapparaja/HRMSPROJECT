...
public class MasterReimbursementBillsTest extends TestBase{
	...
	public MasterReimbursementBillsTest() {
		super();
	}
...
//	}
	...
	@Test(priority=2)
	public void verifyReimbursementBillsCheck() throws InterruptedException {
		
		String valuecheck=Bills.ReimbursementBillsList(prop.getProperty("BillsComponent"));
		System.out.println(valuecheck);
//		Assert.assertEquals("Unapproved list is Empty", valuecheck);	
	}
	
	@Test(priority=3)
	public void verifyMasterReimbursementBillsPagination() throws InterruptedException {
		
		Bills.isnextbuttonReimbursementBillsVisible();
