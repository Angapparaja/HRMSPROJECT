...
public class MasterStatutoryPFTest extends TestBase{
...
//	}
	...
	@Test(priority=2)
	public void verifyStatutoryPfAddCheck() throws InterruptedException {
		
	Assert.assertTrue(StatutoryPf.MasterStatutoryMenuPFAdd(prop.getProperty("PfRulename"),prop.getProperty("PfCeilingAmount"),prop.getProperty("PfemployerRestrictedTo"),
			                                               prop.getProperty("PfEffectivedatemonth"),prop.getProperty("Pfeffectiveyear"),prop.getProperty("Pfeffectivedate"),
			                                               prop.getProperty("PfEMPRestrictedTO"),prop.getProperty("Pfageless"),prop.getProperty("PfempContriageless"),	
	                                                       prop.getProperty("PfempContriageGreater"),prop.getProperty("PfnewJoinee"),prop.getProperty("PfempContriEPFageless"),
	                                                       prop.getProperty("PfempContriEPFageGreater"),prop.getProperty("PfEPFnewJoinee"),prop.getProperty("PfempContriEPSageless"),prop.getProperty("PfempContriEPSageGreater"),
	                                                       prop.getProperty("PfEPSnewJoinee"),prop.getProperty("PfempContriEDLIageless"),prop.getProperty("PfempContriEDLIageGreater"),
	                                                       prop.getProperty("PfEDLInewJoinee"),prop.getProperty("PfempContriADMINEPFageless"),prop.getProperty("PfempContriADMINEPFageGreater"),
	                                                       prop.getProperty("PfADMINEPFnewJoinee"),prop.getProperty("PfempContriADMINEDLIageless"),prop.getProperty("PfempContriADMINEDLIageGreater"),
	                                                       prop.getProperty("PfADMINEDLInewJoinee")));
	}
	
	@Test(priority=3)
	public void verifyStatutoryMonthlyComponentMandatoryFieldCheck() throws InterruptedException {
		
	String valuecheck=StatutoryPf.MasterStatutoryMenuMonthlyComponentMandatoryFieldCheck(prop.getProperty("PfRulename"),prop.getProperty("PfCeilingAmount"),prop.getProperty("PfemployerRestrictedTo"),
			                                               prop.getProperty("PfEffectivedatemonth"),prop.getProperty("Pfeffectiveyear"),prop.getProperty("Pfeffectivedate"),
			                                               prop.getProperty("PfEMPRestrictedTO"),prop.getProperty("Pfageless"),prop.getProperty("PfempContriageless"),	
	                                                       prop.getProperty("PfempContriageGreater"),prop.getProperty("PfnewJoinee"),prop.getProperty("PfempContriEPFageless"),
	                                                       prop.getProperty("PfempContriEPFageGreater"),prop.getProperty("PfEPFnewJoinee"),prop.getProperty("PfempContriEPSageless"),prop.getProperty("PfempContriEPSageGreater"),
	...
	Assert.assertEquals("Select the Monthly Components", valuecheck);	
	}
	@Test(priority=4)
