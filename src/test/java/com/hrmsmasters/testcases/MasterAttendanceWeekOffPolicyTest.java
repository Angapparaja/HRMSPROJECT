...
public class MasterAttendanceWeekOffPolicyTest extends TestBase{
	LoginPage loginPage;
	...
	public MasterAttendanceWeekOffPolicyTest() {
		super();
	}
...
//	
	...
	@Test(priority=2)
	public void verifyWeekoffpolicyadd() throws InterruptedException {
		
	weekOffpolicy.AttendanceWeekoffpolicyAdd(prop.getProperty("POLICYName"),prop.getProperty("WEEK1"),prop.getProperty("WEEK2"),prop.getProperty("PolicyStatus"));	
...
//	}
	...
	@Test(priority=4)
	public void verifyAttendanceWeekoffpolicyNameMandatroyField() throws InterruptedException {
		
		String valuecheck=weekOffpolicy.AttendanceWeekoffpolicyMandatoryFieldVaidation(prop.getProperty("WEEK1"),prop.getProperty("WEEK2"),prop.getProperty("PolicyStatus"));
		System.out.println(valuecheck);
		Assert.assertEquals("Please Enter Policy Name", valuecheck);	
	}
	
	
	@Test(priority=5)
	public void verifyAttendanceWeekoffpolicyStatusMandatroyField() throws InterruptedException {
		
		String valuecheck=weekOffpolicy.AttendanceWeekoffpolicyStatusMandatoryFieldVaidation(prop.getProperty("POLICYName"),prop.getProperty("WEEK1"),prop.getProperty("WEEK2"));
		System.out.println(valuecheck);
		Assert.assertEquals("Please Select Policy Status", valuecheck);	
	}
...
//	@Test(priority=6)
//	public void verifyAttendanceWeekoffpolicyDuplicateCheck() throws InterruptedException {
//		
//		String valuecheck=weekOffpolicy.positionCenterDuplicateCheck(prop.getProperty("POLICYName"),prop.getProperty("WEEK1"),prop.getProperty("WEEK2"),prop.getProperty("PolicyStatus"));
//		System.out.println(valuecheck);
//		Assert.assertEquals("Duplicate Data - Please check", valuecheck);	
//	}
	
	@Test(priority=7)
	public void verifyAttendanceWeekoffpolicyResetButton() throws InterruptedException {
		
	 Assert.assertTrue(weekOffpolicy.verifyPositionCenterResetButton(prop.getProperty("POLICYName"),prop.getProperty("WEEK1"),prop.getProperty("WEEK2"),prop.getProperty("PolicyStatus")));	
	
	}
	
//	@Test(priority=8)
//	public void verifyAttendanceWeekoffpolicyPagination() throws InterruptedException {
//		
//		weekOffpolicy.isnextbuttonPaginationVisible();
//		
//			
//	}
	...
	public void VerifyEnterTheSearchAttendanceWeekoffpolicyPagination() throws InterruptedException {
		weekOffpolicy.searchAttendanceWeekoffPolicypagination(prop.getProperty("SearchNameWeekOffPolicy"),prop.getProperty("SearchNamecheckCondition"));
	}
