...
public class MasterReimbursementProcessTest extends TestBase{
	...
	public MasterReimbursementProcessTest() {
		super();
	}
...
//	}
	...
	processReimbursement.ReimbursementBillsList(prop.getProperty("Year&month"));	
	...
	public void verifyReimbursementProcessrumCommandCheck() throws InterruptedException {
		...
		String valuecheck=processReimbursement.ReimbursementBillsListRunCommand(prop.getProperty("Year&month"));
		System.out.println(valuecheck);
//		Assert.assertEquals("Reimbursement Component of Property Not Set", valuecheck);	
	}
	
	@Test(priority=4)
	public void verifyReimbursementsetupReimbursementComponentMandatroyField() throws InterruptedException {
		
		String valuecheck=processReimbursement.ReimbursementProcessYearmonthMandatoryFieldCheck();
		System.out.println(valuecheck);
...
//		
//		processReimbursement.isnextbuttonReimbursementProcessVisible();
//	
//	}
