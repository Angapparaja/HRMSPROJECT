...
public class MasterPayRollPayrollGroupingTest extends TestBase{
	LoginPage loginPage;
...
SoftAssert softAssert = new SoftAssert();
	...
	public MasterPayRollPayrollGroupingTest() {
		super();
	}
...
//	}
	...
	@Test(priority=2)
	public void verifyAddPayrollGrouping() throws InterruptedException {
		Assert.assertTrue(MasterPayrollGrouping.addPayrollGrouping(prop.getProperty("PAYROLLGROUPING")));
		
	}
	
	@Test(priority=4)
	public void verifyPayrollGroupingMandatoryFieldCheck() throws InterruptedException {
		String valuecheck=(MasterPayrollGrouping.PayrollGroupingMandatoryFieldCheck());
		System.out.println(valuecheck);
		Assert.assertEquals("Enter Payroll Grouping Name", valuecheck);		
	}
	
//	@Test(priority=5)
//	public void verifyPayrollGroupingDuplicateCheckField() throws InterruptedException {
//		String valuecheck=(MasterPayrollGrouping.PayrollGroupingDuplicateCheck(prop.getProperty("DUPLICATEPAYROLLGROUPING")));
//		System.out.println(valuecheck);
...
//	}
	...
	@Test(priority=6)
	public void verifyPayRollGroupingResetBtn() throws InterruptedException {
		
		Assert.assertTrue(MasterPayrollGrouping.ResetBtnPayrollGrouping(prop.getProperty("PAYROLLGROUPING")));
...
//		
//		MasterPayrollGrouping.isnextbuttonPaginationVisible();
//		
//			
//	}
	
	@Test(priority=8)
	public void VerifyEnterTheSearchPayrollGroupingPagination() throws InterruptedException {
		Assert.assertTrue(MasterPayrollGrouping.searchPayrollGroupingNamepagination(prop.getProperty("SEARCHPAYROLLGROUPING")));
	}
