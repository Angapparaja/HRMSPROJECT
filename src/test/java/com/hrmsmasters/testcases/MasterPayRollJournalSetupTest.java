...
public class MasterPayRollJournalSetupTest extends TestBase{
	LoginPage loginPage;
...
SoftAssert softAssert = new SoftAssert();
	...
	public MasterPayRollJournalSetupTest() {
		super();
	}
...
//	}
	...
	@Test(priority=2)
	public void verifyUpdatePayRollJournalSetup() throws InterruptedException {
		Assert.assertTrue(MasterJournalSetup.UpdatePayRollJournalSetup());
...
//	
	@Test(priority=3)
	public void verifyPayRollJournalSetupResetBtn() throws InterruptedException {
		
		Assert.assertTrue(MasterJournalSetup.ResetButtonPayRollJournalSetup());
...
//		
//		MasterJournalSetup.isnextbuttonPaginationVisible();
//		
//			
//	}
