...
public class MasterAttendanceAttentPolicyTest extends TestBase{
...
SoftAssert softAssert = new SoftAssert();
	...
	public MasterAttendanceAttentPolicyTest() {
		super();
	}
...
//	}
	...
	@Test(priority=2)
	public void verifyAddAttentPolicy() throws InterruptedException {
	masterAttePolicy.addPolicy(prop.getProperty("POLICYNAME"),prop.getProperty("POLICYDescription"));
	
	}
	
	@Test(priority=3)
	public void verifyAttentPolicyNameMandatoryFieldCheck() throws InterruptedException {
		
		String valuecheck=(masterAttePolicy.PolicyNameMandatoryFieldCheck(prop.getProperty("POLICYDescription")));	
		System.out.println(valuecheck);
		Assert.assertEquals("Enter policy name", valuecheck);		
	}
	
	@Test(priority=4)
	public void verifyAttentPolicyDescriptionMandatoryFieldCheck() throws InterruptedException {
		
		String valuecheck=(masterAttePolicy.PolicyDescriptionMandatoryFieldCheck(prop.getProperty("POLICYDescription")));	
		System.out.println(valuecheck);
		Assert.assertEquals("Enter policy description", valuecheck);		
	}
	
	@Test(priority=5)
	public void verifyResetAttentPolicy() throws InterruptedException {
		Assert.assertTrue(masterAttePolicy.ResetBtnPolicy(prop.getProperty("POLICYNAME"),prop.getProperty("POLICYDescription")));
...
//		
//		masterAttePolicy.isnextbuttonPaginationVisible();
//		
//			
//	}
	...
	public void VerifyEnterTheSearchPositionTitlePagination() throws InterruptedException {
		Assert.assertTrue(masterAttePolicy.searchAttendentPolicyNamepagination(prop.getProperty("SearchPolicyDecription")));
	}
