...
public class MasterReimbursementMonthlyPayListsTest extends TestBase{
	LoginPage loginPage;
	...
	public MasterReimbursementMonthlyPayListsTest() {
		super();
	}
...
//	}
	...
	@Test(priority=2)
	public void verifyReimbursementProcessCheck() throws InterruptedException {
		
	Assert.assertTrue(MonthlyPayLists.ReimbursementMonthlyPayList(prop.getProperty("Year&monthlist")));	
					
	}
	
	@Test(priority=3)
	public void verifyReimbursementProcessrumCommandCheck() throws InterruptedException {
		
		String valuecheck=MonthlyPayLists.ReimbursementMonthlyPayListRunCommand(prop.getProperty("Year&monthlist"));
		System.out.println(valuecheck);
		Assert.assertEquals("No Data for this Month/Year", valuecheck);	
	}
	
	@Test(priority=4)
	public void verifyReimbursementsetupReimbursementComponentMandatroyField() throws InterruptedException {
		
		String valuecheck=MonthlyPayLists.ReimbursementMonthlyPayListYearmonthMandatoryFieldCheck();
		System.out.println(valuecheck);
		Assert.assertEquals("select year and month", valuecheck);	
	}
	
//	@Test(priority=5)
//	public void verifyMasterReimbursementProcessPagination() throws InterruptedException {
//		
//		MonthlyPayLists.isnextbuttonReimbursementMonthlyPayListVisible();
//	
//	}
