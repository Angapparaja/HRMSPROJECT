...
public class MasterStatutoryPTTEST extends TestBase{
...
//	}
	...
	@Test(priority=2)
	public void verifyStatutoryPTAddCheck() throws InterruptedException {
		
	StatutoryPT.MasterStatutoryMenuPTAdd(prop.getProperty("PTPOLICYNAME"),prop.getProperty("PTCOUNTRY"),prop.getProperty("PTSTATE"),
			                                               prop.getProperty("PTCITY"),prop.getProperty("PTSLABTO"),prop.getProperty("PTCONTRIBUTE"));
	}
	
	@Test(priority=3)
	public void verifyStatutoryMenuPTResetButtonCheck() throws InterruptedException {
		
		StatutoryPT.MasterStatutoryMenuPTResetButton(prop.getProperty("PTPOLICYNAME"),prop.getProperty("PTCOUNTRY"),prop.getProperty("PTSTATE"),
                prop.getProperty("PTCITY"),prop.getProperty("PTSLABTO"),prop.getProperty("PTCONTRIBUTE"));
	...
	@Test(priority=4)
	public void verifyStatutoryMenuPTPolicynameMandatoryFieldCheck() throws InterruptedException {
		
	String valuecheck=StatutoryPT.MasterStatutoryMenuPTPolicyNameMandtoryFieldCheck(
			prop.getProperty("PTCOUNTRY"),prop.getProperty("PTSTATE"),
            prop.getProperty("PTCITY"),prop.getProperty("PTSLABTO"),prop.getProperty("PTCONTRIBUTE"));
	System.out.println(valuecheck);
//	Assert.assertEquals("Enter the PT Policy Name", valuecheck);	
	}
	
	
	@Test(priority=6)
	public void verifyStatutoryMenuPTCOUNTRYMandatoryFieldCheck() throws InterruptedException {
		
	String valuecheck=StatutoryPT.MasterStatutoryMenuPTCountryMandtoryFieldCheck( prop.getProperty("PTPOLICYNAME"),prop.getProperty("PTSTATE"),
            prop.getProperty("PTCITY"),prop.getProperty("PTSLABTO"),prop.getProperty("PTCONTRIBUTE"));
	System.out.println(valuecheck);
//	Assert.assertEquals("Please Fill All the Fields Properly", valuecheck);	
	}
	
//	@Test(priority=7)
//	public void verifyStatutoryMenuPTSTATEMandatoryFieldCheck() throws InterruptedException {
//		
//	String valuecheck=StatutoryPT.MasterStatutoryMenuPTStateMandtoryFieldCheck(prop.getProperty("PTPOLICYNAME"),prop.getProperty("PTCOUNTRY"),
//            prop.getProperty("PTCITY"),prop.getProperty("PTSLABTO"),prop.getProperty("PTCONTRIBUTE"));
//	System.out.println(valuecheck);
//	Assert.assertEquals("Please Fill All the Fields Properly", valuecheck);	
//	}
//	
//	@Test(priority=8)
//	public void verifyStatutoryMenuPTCITYMandatoryFieldCheck() throws InterruptedException {
//		
//	String valuecheck=StatutoryPT.MasterStatutoryMenuPTCityMandtoryFieldCheck(prop.getProperty("PTPOLICYNAME"),prop.getProperty("PTCOUNTRY"),
//            prop.getProperty("PTSTATE"),prop.getProperty("PTSLABTO"),prop.getProperty("PTCONTRIBUTE"));
//	System.out.println(valuecheck);
//	Assert.assertEquals("Please Fill All the Fields Properly", valuecheck);	
//	}
	
//	@Test(priority=9)
//	public void verifyStatutoryMenuPTSlabMandatoryFieldCheck() throws InterruptedException {
//		
//	String valuecheck=StatutoryPT.MasterStatutoryMenuPTSlabMandtoryFieldCheck(prop.getProperty("PTPOLICYNAME"),prop.getProperty("PTCOUNTRY"),prop.getProperty("PTSTATE"),
//            prop.getProperty("PTCITY"),prop.getProperty("PTCONTRIBUTE"));
//	System.out.println(valuecheck);
//	Assert.assertEquals("Enter the Slab Details Properly", valuecheck);	
//	}
//	
//	
//	@Test(priority=10)
//	public void verifyMasterStatutoryMenuPTPagination() throws InterruptedException {
//		
//		StatutoryPT.isnextbuttonStatutoryPTPaginationVisible();
//	
//	}
	
	@Test(priority=11)
	public void VerifyEnterTsearchStatutoryMenuPTpagination() throws InterruptedException {
		StatutoryPT.searchStatutoryPTpagination(prop.getProperty("SearchNameStatutoryPt"),prop.getProperty("SearchNameStatutoryPtcheck"));
	}
	
//	@Test(priority=12)
//	public void verifyMastersearchStatutoryPtEditValue() throws InterruptedException {
//		
//		String valuecheck=StatutoryPT.searchStatutoryPTEdit(prop.getProperty("SearchNameStatutoryPtvalue"),prop.getProperty("SearchBoxeditStatutoryPtvalue"));
//	//	System.out.println(valuecheck);
