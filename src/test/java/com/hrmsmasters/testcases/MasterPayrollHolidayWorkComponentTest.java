...
public class MasterPayrollHolidayWorkComponentTest extends TestBase{
	...
	public MasterPayrollHolidayWorkComponentTest() {
		super();
	}
...
//	}
	...
	@Test(priority=2)
	public void verifyPayrollHolidayWorkComponentadd() throws InterruptedException {
		
	Assert.assertTrue(holidaywork.PayrollHolidayWorkComponentAdd(prop.getProperty("HOLIDAYtype")));	
...
//	}
	...
	@Test(priority=4)
	public void verifyMasterPayrollHolidayWorkHolidayTypeComponentMandatroyField() throws InterruptedException {
		
		String valuecheck=holidaywork.PayrollHolidayWorkComponentHolidayTypeMandatoryFieldVaidation();
		System.out.println(valuecheck);
		Assert.assertEquals("Select the Holiday Type", valuecheck);	
	}
	
	
//	@Test(priority=5)
//	public void verifyMasterPayrollHolidayWorkWagesMandatroyField() throws InterruptedException {
//		
//		String valuecheck=holidaywork.PayrollHolidayWorkWagesComponentMandatoryFieldVaidation(prop.getProperty("HOLIDAYtype"));
//		System.out.println(valuecheck);
//		Assert.assertEquals("Select the wages", valuecheck);	
//	}
	
	@Test(priority=6)
	public void verifyMasterPayrollHolidayWorkMonthlyComponentMandatroyField() throws InterruptedException {
		
		String valuecheck=holidaywork.PayrollHolidayWorkMonthlyComponentMandatoryFieldVaidation(prop.getProperty("HOLIDAYtype"));
		System.out.println(valuecheck);
		Assert.assertEquals("Select the Componant", valuecheck);	
	}
...
//	}
	...
	public void verifyMasterPayrollPaySlipTitleResetButton() throws InterruptedException {
	 ...
	 Assert.assertTrue(holidaywork.verifyPayrollHolidayWorkComponentResetButton(prop.getProperty("HOLIDAYtype")));	
	
	}
	
//	@Test(priority=9)
//	public void verifyMasterPayrollHolidayWorkComponentPagination() throws InterruptedException {
//		
//		holidaywork.isnextbuttonPayrollHolidayWorkComponentVisible();
//		
//			
//	}
	...
	@Test(priority=10)
	public void VerifyEnterTheSearchMasterPayrollHolidayWorkComponentPagination() throws InterruptedException {
