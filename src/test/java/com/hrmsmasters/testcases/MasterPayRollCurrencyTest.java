...
public class MasterPayRollCurrencyTest extends TestBase{
...
SoftAssert softAssert = new SoftAssert();
	...
	public MasterPayRollCurrencyTest() {
		super();
	}
...
//	}
	...
	@Test(priority=2)
	public void verifyAddPayRollCurrency() throws InterruptedException {
		
		Assert.assertTrue(MasterPayCurrenncy.addPayRollCurrency(prop.getProperty("CountryNamecurrency"),prop.getProperty("CurrencyNamecurrency"),prop.getProperty("CurrencySymbolcurrency")));		
	}
	
	@Test(priority=3)
	public void verifyPayRollCurrencyNameNegativeCheckVaidation() throws InterruptedException {
		
		String FieldVaidation = MasterPayCurrenncy.addPayRollCurrencyNameNegativecheck(prop.getProperty("CountryNamecurrency"),prop.getProperty("CurrencyNameNegativeCheck"),prop.getProperty("CurrencySymbolcurrency"));
		System.out.println(FieldVaidation);
		Assert.assertEquals("Enter currency Name", FieldVaidation);	
	}
	
	@Test(priority=4)
	public void verifyPayRollCurrencyCountryNameMandatoryFieldVaidation() throws InterruptedException {
		
		String CurrencyCountryNameMandatoryFieldVaidation = MasterPayCurrenncy.addCurrencyCountryNameMandatoryFieldVaidation(prop.getProperty("CurrencyNamecurrency"),prop.getProperty("CurrencySymbolcurrency"));
		System.out.println(CurrencyCountryNameMandatoryFieldVaidation);
		Assert.assertEquals("Select Country Name", CurrencyCountryNameMandatoryFieldVaidation);	
	}
	
	@Test(priority=5)
	public void verifyPayRollCurrencyNameMandatoryFieldVaidation() throws InterruptedException {
		String PayRollCurrencyNameMandatoryFieldVaidation =MasterPayCurrenncy.addCurrencyNameMandatoryFieldVaidation(prop.getProperty("CountryNamecurrency"),prop.getProperty("CurrencySymbolcurrency"));	
		System.out.println(PayRollCurrencyNameMandatoryFieldVaidation);
		Assert.assertEquals("Enter currency Name", PayRollCurrencyNameMandatoryFieldVaidation);	
	}
	
	@Test(priority=6)
	public void verifyPayRollCurrencySymbolMandatoryFieldVaidation() throws InterruptedException {
		String CurrencySymbolMandatoryFieldVaidation =MasterPayCurrenncy.addCurrencySymbolMandatoryFieldVaidation(prop.getProperty("CountryNamecurrency"),prop.getProperty("CurrencyNamecurrency"));	
		System.out.println(CurrencySymbolMandatoryFieldVaidation);
		Assert.assertEquals("Enter currency Symbol", CurrencySymbolMandatoryFieldVaidation);	
	}
	
//	@Test(priority=7)
//	public void verifyPayRollCurrencyDuplicateCheck() throws InterruptedException {
//		String PayRollCurrencyDuplicateCheckValidation= MasterPayCurrenncy.addPayRollCurrencyDuplicateCheckValidation(prop.getProperty("DuplicateCountryName"),prop.getProperty("DuplicateCurrencyName"),prop.getProperty("DuplicateCurrencySymbol"));
//		System.out.println(PayRollCurrencyDuplicateCheckValidation);
//		//Assert.assertEquals("Duplicate Data Please Check",PayRollCurrencyDuplicateCheckValidation);	
...
//	
	@Test(priority=8)
	public void verifyPayRollCurrencyResetBtn() throws InterruptedException {
		
	Assert.assertTrue(MasterPayCurrenncy.addCurrencyResetButton(prop.getProperty("CountryNamecurrency"),prop.getProperty("CurrencyNamecurrency"),prop.getProperty("CurrencySymbolcurrency")));
...
//		MasterPayCurrenncy.isnextbuttonPaginationVisible();
//		
//			
//	}
	...
	@Test(priority=10)
	public void VerifyEnterTheSearchPayrollCurrencyPagination() throws InterruptedException {
		Assert.assertTrue(MasterPayCurrenncy.searchPositionTitleNamepagination(prop.getProperty("SearchCountryName")));
	}
