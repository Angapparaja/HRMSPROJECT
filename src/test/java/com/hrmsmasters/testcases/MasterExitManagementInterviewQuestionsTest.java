...
public class MasterExitManagementInterviewQuestionsTest extends TestBase{
	LoginPage loginPage;
...
SoftAssert softAssert = new SoftAssert();
	...
	public MasterExitManagementInterviewQuestionsTest() {
		super();
	}
...
//	}
	@Test(priority=2)
	public void verifyAddExitManagementInterviewQuestions() throws InterruptedException {
		Assert.assertTrue(masterInterview.addMasterExitManagementInterviewQuestions(prop.getProperty("Feedback")));
		
	}
	
	@Test(priority=3)
	public void verifyMasterExitManagementInterviewQuestionsNegativeCheck() throws InterruptedException {
		
		String MasterExitManagementCheck= masterInterview.MasterExitManagementInterviewQuestionsNegativeCheck(prop.getProperty("NegativeFeedback"));
		System.out.println(MasterExitManagementCheck);
		Assert.assertEquals("Enter valid feedback question",MasterExitManagementCheck);		
	}
	
	@Test(priority=4)
	public void verifyMasterExitManagementInterviewQuestionsMandatoryFieldCheck() throws InterruptedException {
		
		String MasterExitManagementCheck= masterInterview.addMasterExitManagementInterviewQuestionsMandatoryFieldCheckValidation();
		System.out.println(MasterExitManagementCheck);
		Assert.assertEquals("Enter feedback question",MasterExitManagementCheck);		
	}
	
	@Test(priority=5)
	public void verifyMasterExitManagementInterviewQuestionsreset() throws InterruptedException {
		
	Assert.assertTrue(masterInterview.addMasterExitManagementInterviewQuestionsResetButton(prop.getProperty("Feedback")));
...
//		
//		masterInterview.isnextbuttonPaginationVisible();
//		
//			
//	}
	
	@Test(priority=7)
	public void VerifyEnterTheSearchInterviewPagination() throws InterruptedException {
		Assert.assertTrue(masterInterview.searchInterviewQuestionNamepagination(prop.getProperty("SearchFeedback")));
	}
