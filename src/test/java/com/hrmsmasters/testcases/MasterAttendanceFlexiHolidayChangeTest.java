...
public class MasterAttendanceFlexiHolidayChangeTest extends TestBase{
	...
	public MasterAttendanceFlexiHolidayChangeTest() {
		super();
	}
	...
	@Test(priority=2)
	public void verifyFlexiHolidayChangeadd() throws InterruptedException {
		
	Assert.assertTrue(FlexiHolidayChange.AttendanceFlexiHolidayChangeAdd(prop.getProperty("Employeecode"),prop.getProperty("Year")));	
					
	}
	
	@Test(priority=3)
	public void verifyListTheHolidayValue() throws InterruptedException {
		
		String valuecheck=FlexiHolidayChange.AttendanceFlexiHolidayChangeCheckHolidays(prop.getProperty("Employeecode"),prop.getProperty("Year"));
//		System.out.println(valuecheck);
		Assert.assertEquals("TOTAL HOLIDAYS THIS YEAR"
				, valuecheck);	
	}
