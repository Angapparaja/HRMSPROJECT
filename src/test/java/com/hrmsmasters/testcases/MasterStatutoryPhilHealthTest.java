...
public class MasterStatutoryPhilHealthTest extends TestBase{
	LoginPage loginPage;
...
SoftAssert softAssert = new SoftAssert();
	...
	public MasterStatutoryPhilHealthTest() {
		super();
	}
	...
	@Test(priority=2)
	public void verifyAddStatutoryPhilHealth() throws InterruptedException {
		
		Assert.assertTrue(masterStatory.addPhilhealth(prop.getProperty("EFFECTIVEMONTH"),prop.getProperty("EffectiveDate"),prop.getProperty("slabRange"),prop.getProperty("Employee"),prop.getProperty("Employer")));
		
	}
	@Test(priority=3)
	public void verifyStatutoryPhilHealthEffectiveDateMandatoryFieldCheck() throws InterruptedException {
		
		String PhilhealthsDuplicateCheck= masterStatory.addPhilhealthsEffectiveDateMandatoryFieldValidation(prop.getProperty("slabRange"),prop.getProperty("Employee"),prop.getProperty("Employer"));
		System.out.println(PhilhealthsDuplicateCheck);
		Assert.assertEquals("Please Select Effective Date",PhilhealthsDuplicateCheck);		
	}
	
	@Test(priority=4)
	public void verifyStatutoryPhilHealthDuplicateCheck() throws InterruptedException {
		
		String PhilhealthsDuplicateCheck= masterStatory.addPhilhealthsDuplicateCheckValidation(prop.getProperty("EFFECTIVEMONTH"),prop.getProperty("EffectiveDate"),prop.getProperty("slabRange"),prop.getProperty("Employee"),prop.getProperty("Employer"));
		System.out.println(PhilhealthsDuplicateCheck);
		Assert.assertEquals("Date Already Exist",PhilhealthsDuplicateCheck);		
	}
	
	@Test(priority=5)
	public void verifyStatutoryPhilHealthreset() throws InterruptedException {
		
	Assert.assertTrue(masterStatory.addPhilhealthResetButton(prop.getProperty("EFFECTIVEMONTH"),prop.getProperty("EffectiveDate"),prop.getProperty("slabRange"),prop.getProperty("Employee"),prop.getProperty("Employer")));
		
			
	}
	
	@Test(priority=6)
	public void verifyStatutoryPhilHealthPagination() throws InterruptedException {
		
		masterStatory.isnextbuttonPaginationVisible();
		
			
	}
	
	@Test(priority=7)
	public void VerifyEnterTheSearchStatutoryPhilHealthPagination() throws InterruptedException {
		Assert.assertTrue(masterStatory.searchPhilhealthNamepagination(prop.getProperty("searchEffectiveDate")));
	}
