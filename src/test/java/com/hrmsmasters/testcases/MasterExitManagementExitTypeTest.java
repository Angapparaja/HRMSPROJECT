...
public class MasterExitManagementExitTypeTest extends TestBase{
	LoginPage loginPage;
...
SoftAssert softAssert = new SoftAssert();
	...
	public MasterExitManagementExitTypeTest() {
		super();
	}
...
//	}
	@Test(priority=2)
	public void verifyAddExitManagementExitType() throws InterruptedException {
		Assert.assertTrue(masterExitType.addMasterExitManagementExitType(prop.getProperty("ExitType"),prop.getProperty("Reasonleaving")));
		
	}
	
	@Test(priority=3)
	public void verifyExitManagementExitTypeNegativeCheck() throws InterruptedException {
		
		String StatutoryExitManagementExitTypeDuplicateCheck= masterExitType.MasterExitManagementExitTypeNegativeCheck(prop.getProperty("ExittypeNegativecheck"),prop.getProperty("Reasonleaving"));
		System.out.println(StatutoryExitManagementExitTypeDuplicateCheck);
		Assert.assertEquals("Please Enter Valid Exit Type",StatutoryExitManagementExitTypeDuplicateCheck);		
	}
	
	@Test(priority=4)
	public void verifyExitManagementExitTypeMandatoryfieldCheck() throws InterruptedException {
		
		String ExitManagementExitTypeDuplicateCheck= masterExitType.MasterExitManagementExitTypeMandatoryField(prop.getProperty("Reasonleaving"));
		System.out.println(ExitManagementExitTypeDuplicateCheck);
		Assert.assertEquals("Please Enter exitType",ExitManagementExitTypeDuplicateCheck);		
	}
	
	@Test(priority=5)
	public void verifyExitManagementReasonforLeavingMandatoryfieldCheck() throws InterruptedException {
		
		String ManagementExitTypeDuplicateCheck= masterExitType.MasterExitManagementreasonleavingMandatoryField(prop.getProperty("ExitType"));
		System.out.println(ManagementExitTypeDuplicateCheck);
		Assert.assertEquals("Please Enter Valid Reason For Leaving",ManagementExitTypeDuplicateCheck);		
	}
	
//	@Test(priority=6)
//	public void verifyExitManagementExitTypeDuplicateCheck() throws InterruptedException {
//		
//		String ExitTypeDuplicateCheck= masterExitType.addMasterExitManagementExitTypeDuplicateCheckValidation(prop.getProperty("DuplicateExitType"),prop.getProperty("DuplicateReasonleaving"));
//		System.out.println(ExitTypeDuplicateCheck);
//		Assert.assertEquals("Duplicate Data - Please check",ExitTypeDuplicateCheck);		
//	}
	
	@Test(priority=7)
	public void verifyExitManagementExitTypereset() throws InterruptedException {
		
	Assert.assertTrue(masterExitType.addMasterExitManagementExitTypeResetButton(prop.getProperty("ExitType"),prop.getProperty("Reasonleaving")));
...
//		
//		masterExitType.isnextbuttonPaginationVisible();
//		
//			
//	}
	
	@Test(priority=9)
	public void VerifyEnterTheSearchExitTypePagination() throws InterruptedException {
		Assert.assertTrue(masterExitType.searchExitManagementNamepagination(prop.getProperty("SearchExitType")));
	}
