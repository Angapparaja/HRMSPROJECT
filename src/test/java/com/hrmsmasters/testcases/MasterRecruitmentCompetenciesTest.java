...
public class MasterRecruitmentCompetenciesTest extends TestBase{
	...
	public MasterRecruitmentCompetenciesTest() {
		super();
	}
...
//	}
	...
	@Test(priority=2)
	public void verifyaddCompetenciesBehavioural() throws InterruptedException {
		
		Assert.assertTrue(addCompetencies.addCompetenciesBehavioural(prop.getProperty("addCompetenciesBehaviouralName"),prop.getProperty("addCompetenciesBehaviouralGroup"),prop.getProperty("addCompetenciesBehaviouralDescription"))); 
					
	}
	
	@Test(priority=3)
	public void verifyaddCompetenciesfuncional() throws InterruptedException {
		
	Assert.assertTrue(addCompetencies.addCompetenciesFunctional(prop.getProperty("addCompetenciesBehaviouralName"),prop.getProperty("addCompetenciesBehaviouralGroup"),prop.getProperty("addCompetenciesBehaviouralDescription")));	
			
	}
	
	@Test(priority=4)
	public void verifyaddCompetenciesfuncionalPositiveIndictor() throws InterruptedException {
		
	 Assert.assertTrue(addCompetencies.addCompetenciesFunctionalPostiveIndi(prop.getProperty("PositiveIndicatorvalue")));	
			
	}
	
		
	@Test(priority=5)
	public void verifyAddCompetenciesFunctionalNegativeIndi() throws InterruptedException {
		
		String Competenciesname= addCompetencies.addCompetenciesFunctionalNegativeIndi(prop.getProperty("CompetenciesFunctionalNegativeCompName"));
		System.out.println(Competenciesname);
		Assert.assertEquals("Please Enter Name", Competenciesname);
	...
	@Test(priority=6)
	public void verifyRecruitmentCompetenciesResetButtons() throws InterruptedException {
		
	Assert.assertTrue(addCompetencies.verifyRecruitmentCompetenciesResetButton(prop.getProperty("addCompetenciesBehaviouralName"),prop.getProperty("addCompetenciesBehaviouralGroup"),prop.getProperty("addCompetenciesBehaviouralDescription")));	
		
			
	}
	
//	@Test(priority=7)
//	public void verifyRecruitmentCompetenciesPagination() throws InterruptedException {
//		
//		addCompetencies.isnextbuttonPaginationVisible();
//					
//	}
	
	@Test(priority=8)
	public void VerifyEnterTheSearchRecruitmentCompetenciesPagination() throws InterruptedException {
		addCompetencies.searchRecruitmentCompetenciespagination(prop.getProperty("CompentenciesSearch"));
	}
