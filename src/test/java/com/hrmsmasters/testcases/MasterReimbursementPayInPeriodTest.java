...
public class MasterReimbursementPayInPeriodTest extends TestBase{
	...
	public MasterReimbursementPayInPeriodTest() {
		super();
	}
...
//	}
	...
	@Test(priority=2)
	public void verifyReimbursementPayInPeriodMenuCheck() throws InterruptedException {
		
	payinperoiod.ReimbursementPayInPeriodMenu(prop.getProperty("EMPCODEPAYINPERIOD"));	
					
	}
	
	@Test(priority=3)
	public void verifyReimbursementPayInPeriodMenuCommandCheck() throws InterruptedException {
		
		String valuecheck=payinperoiod.ReimbursementPayInPeriodMenuRun(prop.getProperty("EMPCODEPAYINPERIOD"));
		System.out.println(valuecheck);
//		Assert.assertEquals("No Employee of Pay In Advance List Avaialble", valuecheck);	
	}
	
	@Test(priority=4)
	public void verifyReimbursementPayInPeriodMenuEMPCODEMandatroyField() throws InterruptedException {
	
		String valuecheck=payinperoiod.ReimbursementPayInPeriodEmpCodeMandatoryFieldCheck();
		System.out.println(valuecheck);
//		Assert.assertEquals("give employee code", valuecheck);	
	}
	
//	@Test(priority=5)
//	public void verifyMasterReimbursementPayInPeriodPagination() throws InterruptedException {
//		
//		payinperoiod.isnextbuttonReimbursementPayInPeriodVisible();
//	
//	}
