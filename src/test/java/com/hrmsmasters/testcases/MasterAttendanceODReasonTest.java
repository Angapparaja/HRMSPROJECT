...
import com.hrms.masters.MasterAttendanceODReason;
...
public class MasterAttendanceODReasonTest extends TestBase{
	...
	MasterAttendanceODReason MasterAttendanceOD;
	...
	public MasterAttendanceODReasonTest() {
		super();
	}
	...
	public void setUp() throws InterruptedException {
		...
		MasterAttendanceOD = new MasterAttendanceODReason();
	...
	@Test(priority=1)
	public void verifyAttandanceaddODReason() throws InterruptedException {
		
	Assert.assertTrue(MasterAttendanceOD.AttendanceODReasonAdd(prop.getProperty("oDmethodName")));	
	...
	@Test(priority=2)
	public void verifyAttendanceODReasonResetButton() throws InterruptedException {
		
	 Assert.assertTrue(MasterAttendanceOD.verifyAttendanceODReasonResetButton(prop.getProperty("oDmethodName")));	
	
	}
	
	@Test(priority=3)
	public void verifyAttandanceODReasonMandatroyField() throws InterruptedException {
		
		String valuecheck=MasterAttendanceOD.AttendanceODReasonNameMandatoryFieldVaidation();
		System.out.println(valuecheck);
		Assert.assertEquals("Enter Od Reason", valuecheck);	
	}
