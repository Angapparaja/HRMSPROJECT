...
public class MasterExitManagementSetupTest  extends TestBase{
	LoginPage loginPage;
...
SoftAssert softAssert = new SoftAssert();
	...
	public MasterExitManagementSetupTest() {
		super();
	}
...
//	}
	...
	@Test(priority=2)
	public void verifyUpdateExitManagementSetup() throws InterruptedException {
		
		Assert.assertTrue(masterMangementSetup.UpdateExitmanagementCheckBox(prop.getProperty("baseday")));
