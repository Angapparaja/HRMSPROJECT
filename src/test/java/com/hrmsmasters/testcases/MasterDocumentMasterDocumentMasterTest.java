...
public class MasterDocumentMasterDocumentMasterTest extends TestBase{
...
SoftAssert softAssert = new SoftAssert();
	...
	public MasterDocumentMasterDocumentMasterTest() {
		super();
	}
...
//	}
	@Test(priority=2)
	public void verifyAddDocumentMaster() throws InterruptedException {
		Assert.assertTrue(masDocumentMaster.addMasterDocumentMaster(prop.getProperty("DOCUMENT")));
		
	}
	
	@Test(priority=3)
	public void verifyMasterDocumentMastersNegativeCheck() throws InterruptedException {
		
		String MasterDocumentDuplicateCheck= masDocumentMaster.MasterDocumentMasterNegativeCheck(prop.getProperty("DOCUMENTNegativeCheck"));
		System.out.println(MasterDocumentDuplicateCheck);
		Assert.assertEquals("Enter Document Name",MasterDocumentDuplicateCheck);		
	}
	
	@Test(priority=4)
	public void verifyMasterDocumentMastersMandatoryFieldCheck() throws InterruptedException {
		
		String MasterDocumentCheck= masDocumentMaster.MasterDocumentMasterMandatoryFieldCheck();
		System.out.println(MasterDocumentCheck);
		Assert.assertEquals("Enter Document Name",MasterDocumentCheck);		
	}
	
//	@Test(priority=5)
//	public void verifyMasterDocumentMastersDuplicateCheck() throws InterruptedException {
//		
//		String MasterDocumentDuplicateCheck= masDocumentMaster.addMasterDocumentMasterCheckDuplicateValidation(prop.getProperty("DOCUMENTDuplicateCheck"));
//		System.out.println(MasterDocumentDuplicateCheck);
//	//	Assert.assertEquals("Duplicate Data Please Check",MasterDocumentDuplicateCheck);	
...
//	}
	...
	@Test(priority=6)
	public void verifyMasterDocumentMasterResetButton() throws InterruptedException {
		
	Assert.assertTrue(masDocumentMaster.addMasterDocumentMasterResetButton(prop.getProperty("DOCUMENT")));
		
			
	}
	
//	@Test(priority=7)
//	public void verifyDocumentMasterPagination() throws InterruptedException {
//		
//		masDocumentMaster.isnextbuttonPaginationVisible();
//		
//			
//	}
	
	@Test(priority=8)
	public void VerifyEnterTheSearchDocumentMasterPagination() throws InterruptedException {
		Assert.assertTrue(masDocumentMaster.searchDocumentMasterpagination(prop.getProperty("DOCUMENTSearchName")));
	}
