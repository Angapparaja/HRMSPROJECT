...
public class MasterReimbursementSetupTest extends TestBase{
	...
	public MasterReimbursementSetupTest() {
		super();
	}
...
//	
	...
	@Test(priority=2)
	public void verifyReimbursementsetupCumulativeadd() throws InterruptedException {
		
	Reimbursementsetup.ReimbursementSetupCumulativeRadioBtnAdd(prop.getProperty("Reimbursement"));	
					
	}
	
	@Test(priority=3)
	public void verifyReimbursementsetupMonthlyadd() throws InterruptedException {
		
	Reimbursementsetup.ReimbursementSetupMonthlyradioBtnAdd(prop.getProperty("Reimbursement"));	
...
//	}
	...
	@Test(priority=4)
	public void verifyReimbursementsetupReimbursementComponentMandatroyField() throws InterruptedException {
		
		String valuecheck=Reimbursementsetup.ReimbursementSetupReimbursementMandatoryFieldVaidation();
		System.out.println(valuecheck);
//		Assert.assertEquals("Please Select Reimbursement component", valuecheck);	
	}
	
	
	@Test(priority=5)
	public void verifyMasterReimbursementsetupEntitleComputationMandatroyField() throws InterruptedException {
		
		String valuecheck=Reimbursementsetup.ReimbursementSetupEntitleComputationmethodMandatoryFieldVaidation(prop.getProperty("Reimbursement"));
		System.out.println(valuecheck);
//		Assert.assertEquals("Please Select Any Level", valuecheck);	
	}
	

		
//	@Test(priority=7)
//	public void verifyMasterPayrollHolidayWorkComponentDuplicateCheck() throws InterruptedException {
//		
//		String valuecheck=holidaywork.PayrollPayslipTitleDuplicateCheck(prop.getProperty("DupliBusinessunitpayslip"),prop.getProperty("DupliPayslipTitle"),prop.getProperty("Duplipayslipaddress"));
//		System.out.println(valuecheck);
//		Assert.assertEquals("Duplicate Data - please check", valuecheck);	
//	}
	
	@Test(priority=6)
	public void verifyMasterReimbursementSetupCumulativeRadioBtnResetBtn() throws InterruptedException {
		
	 Reimbursementsetup.ReimbursementSetupCumulativeRadioBtnResetBtn(prop.getProperty("Reimbursement"));	
	
	}
	
	@Test(priority=7)
	public void verifyMasterReimbursementSetupMonthlyradioBtnResetBtn() throws InterruptedException {
		
	Reimbursementsetup.ReimbursementSetupMonthlyradioBtnResetBtn(prop.getProperty("Reimbursement"));	
	
	}
	
//	@Test(priority=8)
//	public void verifyMasterReimbursementSetupPagination() throws InterruptedException {
//		
//		Reimbursementsetup.isnextbuttonReimbursementSetupVisible();
//		
//			
//	}
...
//	@Test(priority=10)
//	public void VerifyEnterTheSearchMasterReimbursementSetupPagination() throws InterruptedException {
//		Assert.assertTrue(holidaywork.searchPayrollHolidayWorkComponentpagination(prop.getProperty("SearchNameholiday"),prop.getProperty("SearchNamecheckCondition")));
//	}
//	
//	@Test(priority=11)
//	public void verifyMasterPayrollHolidayWorkComponentEditValue() throws InterruptedException {
//		
//		String valuecheck=holidaywork.searchPayrollHolidayWorkComponentEdit(prop.getProperty("SearchNameholidays"));
//	//	System.out.println(valuecheck);
