...
public class MasterAttendanceFlexiHolidayPolicyTest extends TestBase{
	...
	public MasterAttendanceFlexiHolidayPolicyTest() {
		super();
	}
	...
	@Test(priority=2)
	public void verifyFlexiHolidayPolicyadd() throws InterruptedException {
		
	Assert.assertTrue(FlexiHolidayPolicy.AttendanceFlexiHolidayPolicyAdd(prop.getProperty("YEAR"),prop.getProperty("WORKLOCATION"),prop.getProperty("WEEKOFFPOLICY"),prop.getProperty("MAXIMUMNOOFHOLIDAY"),prop.getProperty("STANDARDHOLIDAY")));	
					
	}
	
	@Test(priority=3)
	public void verifyAttendanceFlexiHolidayPolicyYearNegativeCheck() throws InterruptedException {
	
	String valuecheck=FlexiHolidayPolicy.AttendanceFlexiHolidayPolicyYearNegativeCheck(prop.getProperty("YearNegativeCheck"),prop.getProperty("WORKLOCATION"),prop.getProperty("WEEKOFFPOLICY"),prop.getProperty("MAXIMUMNOOFHOLIDAY"),prop.getProperty("STANDARDHOLIDAY"));
	System.out.println(valuecheck);
	Assert.assertEquals("Enter the year", valuecheck);				
	}

	
	@Test(priority=4)
	public void verifyAttendanceFlexiHolidayPolicyYearMandatroyField() throws InterruptedException {
		
		String valuecheck=FlexiHolidayPolicy.AttendanceFlexiHolidayPolicyYearMandatoryFieldVaidation(prop.getProperty("WORKLOCATION"),prop.getProperty("WEEKOFFPOLICY"),prop.getProperty("MAXIMUMNOOFHOLIDAY"),prop.getProperty("STANDARDHOLIDAY"));
		System.out.println(valuecheck);
		Assert.assertEquals("Enter the year", valuecheck);	
	}
	...
	@Test(priority=5)
	public void verifyAttendanceFlexiHolidayPolicyWorklocationMandatroyField() throws InterruptedException {
		
		String valuecheck=FlexiHolidayPolicy.AttendanceFlexiHolidayPolicyWorkLocationMandatoryFieldVaidation(prop.getProperty("YEAR"),prop.getProperty("WEEKOFFPOLICY"),prop.getProperty("MAXIMUMNOOFHOLIDAY"),prop.getProperty("STANDARDHOLIDAY"));
		System.out.println(valuecheck);
		Assert.assertEquals("Select the work location", valuecheck);	
	}
	
	@Test(priority=6)
	public void verifyAttendanceFlexiHolidayPolicyWeekOffPolicyMandatroyField() throws InterruptedException {
		
		String valuecheck=FlexiHolidayPolicy.AttendanceFlexiHolidayPolicyWeekOfPolicyMandatoryFieldVaidation(prop.getProperty("YEAR"),prop.getProperty("WORKLOCATION"),prop.getProperty("MAXIMUMNOOFHOLIDAY"),prop.getProperty("STANDARDHOLIDAY"));
		System.out.println(valuecheck);
		Assert.assertEquals("Select the Weekoff Policy", valuecheck);	
	}
	
		
	@Test(priority=7)
	public void verifyAttendanceFlexiHolidayPolicyDuplicateCheck() throws InterruptedException {
		
		String valuecheck=FlexiHolidayPolicy.AttendanceFlexiHolidayPolicyDuplicateCheck(prop.getProperty("YEAR"),prop.getProperty("WORKLOCATION"),prop.getProperty("WEEKOFFPOLICY"),prop.getProperty("MAXIMUMNOOFHOLIDAY"),prop.getProperty("STANDARDHOLIDAY"));
		System.out.println(valuecheck);
		Assert.assertEquals("Select the Standard Holidays / Standard Holidays limit exceeds", valuecheck);	
	}
	
	@Test(priority=8)
	public void verifyAttendanceFlexiHolidayPolicyResetButton() throws InterruptedException {
		
	 Assert.assertTrue(FlexiHolidayPolicy.verifyAttendanceFlexiHolidayPolicyResetButton(prop.getProperty("YEAR"),prop.getProperty("WORKLOCATION"),prop.getProperty("WEEKOFFPOLICY"),prop.getProperty("MAXIMUMNOOFHOLIDAY"),prop.getProperty("STANDARDHOLIDAY")));	
	
	}
	
	@Test(priority=9)
	public void verifyAttendanceFlexiHolidayPolicyPagination() throws InterruptedException {
		
		FlexiHolidayPolicy.isnextbuttonPaginationVisible();
...
//	@Test(priority=9)
//	public void VerifyEnterTheSearchAttendanceWeekoffpolicyPagination() throws InterruptedException {
//		Assert.assertTrue(weekOffpolicy.searchAttendanceWeekoffPolicypagination(prop.getProperty("SearchNameWeekOffPolicy"),prop.getProperty("SearchNamecheckCondition")));
//	}
//	
//	@Test(priority=10)
//	public void verifyAttendanceWeekoffpolicyEditValue() throws InterruptedException {
//		
//		String valuecheck=weekOffpolicy.searchAttendanceWeekOFFPolicyEdit(prop.getProperty("SearchNamePolicy"),prop.getProperty("SearchNamePolicyedit"));
//	//	System.out.println(valuecheck);
